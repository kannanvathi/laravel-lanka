...
<script>
    $.ajax({
        ...
        success: function(data){
            console.log(data);
            var html = '<table class="table table-responsive"><thead><th>id</th><th>user Id</th><th>category</th><th>brand</th></thead><tbody>';
            for(i=0; i<data.length; i++){
                html += '<tr><td>'+ data[i].id +'</td><td>' + data[i].users_id + '</td><td>' + data[i].category + '</td><td>' + data[i].brand + '</td></tr>';
            }
            html += '</tbody></table>';
